...
export function WorkspaceFrame({
  ...
  return (
    <section className="rounded-[2rem] bg-white/55 p-4 shadow-[0_8px_32px_rgba(45,52,49,0.04)] backdrop-blur-sm sm:p-5">
      <div className="rounded-[1.8rem] bg-[#eef2ed] p-5 sm:p-6">
